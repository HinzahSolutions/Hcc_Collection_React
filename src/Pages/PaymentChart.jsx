...
//   const paid = useSelector((state) => state.collection.paid);
//   const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];

//   useEffect(() => {
//     if (!paid || !Array.isArray(paid)) return;

//     const paidData = {};
//     const isAllMonthsSelected = selectedMonth === "All";

//     const filteredPaid = paid.filter((item) => {
//       if (!item.colldate || !item.paidamount) return false;
//       const paymentDate = parseDate(item.colldate);
//       return (
//         paymentDate.getFullYear() === selectedYear &&
//         (isAllMonthsSelected || String(paymentDate.getMonth() + 1).padStart(2, "0") === selectedMonth)
//       );
//     });
...
//       const paymentDate = parseDate(item.colldate);
//       const formattedDate = formatDate(paymentDate);
//       paidData[formattedDate] = (paidData[formattedDate] || 0) + parseFloat(item.paidamount);
//     });
...
//       </style>
//       <div className='text-center d-flex justify-content-center align-items-end'>
//         <Button className="w-auto" onClick={() => setChartType(chartType === 'line' ? 'bar' : 'line')}>
//           Toggle Chart
//         </Button>
//       </div>
//       <div className='chartup'>
